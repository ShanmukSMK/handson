...
create table Trainer_Info(Trainer_Id varchar(20) constraint trainer_id primary key,
...
create table Batch_Info(Batch_Id varchar(20) constraint batch_id primary key,
Batch_Owner varchar(30),
Batch_BU_Name varchar(30))

--create Module_info Table
create table  Module_Info(Module_Id varchar(20) constraint module_id primary key,
Module_Name varchar(40),
Module_Duration int)

--create Associate_Info table
create table Associate_Info(Associate_Id varchar(20) constraint associate_id primary key,
Salutation varchar(7),
...
create table Questions(Question_Id varchar(20) constraint question primary key,
Module_Id varchar(20),
Question_Text varchar(900))

--create Associate_Status table
...
create table Trainer_Feedback(Trainer_Id varchar(20) constraint fk1 foreign key references Trainer_Info(Trainer_Id),
Question_Id varchar(20) constraint fk2 foreign key references Questions(Question_Id),
Batch_Id varchar(20) constraint fk3 foreign key references Batch_Info(Batch_Id),
Module_Id varchar(20) constraint fk4 foreign key references Module_Info(Module_Id),
Trainer_Rating int)

--create Associate_Feedback table
create table Associate_Feedback(Associate_Id varchar(20) constraint fk5 foreign key references Associate_Info(Associate_Id),
Question_Id varchar(20) constraint fk6 foreign key references Questions(Question_Id),
Module_Id varchar(20) constraint fk7 foreign key references Module_Info(Module_Id),
...
alter table Associate_Status add Batch_Id varchar(20) constraint fk8 foreign key references Batch_Info(Batch_Id)
alter table Associate_Status add Trainer_Id varchar(20) constraint fk9 foreign key references Trainer_Info(Trainer_Id)
...
--insert values into trainer info table
...
--insert values into associate info table
...
insert into  Associate_Info(Associate_Id,Salutation,Associate_Name,Associate_Location,Associate_Track,Associate_Qualification,Associate_Email,Associate_Password)
values('A007','Mr.','PRABHAKAR SHUNMUGHAM','Mumbai','Java','Bachelor of Technology','Prabhakar.Shunmugham@honda.com','tne7@123')
